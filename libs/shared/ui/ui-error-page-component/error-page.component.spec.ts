...
describe('ErrorPageComponent', () => {
    ...
    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [RouterTestingModule.withRoutes([]), UiIconsAssetsModule],
    ...
    it('renderiza estado auth com CTA principal de login', () => {
        ...
        fixture.componentInstance.details = { message: 'Sessão inválida' };
    ...
    it('renderiza estado permission com CTA de solicitar acesso', () => {
        ...
        fixture.componentInstance.details = { message: 'Sem permissão' };
