...
export interface IFeatureFlagService {
  ...
  // -------------------------------------------------------------------
  // DEPRECATED: Métodos legados mantidos para compatibilidade temporária
  // Usar isEnabled() e tool() para novos consumos
  // -------------------------------------------------------------------
...
export interface IFlagSnapshot {
  flags: Readonly<Record<string, { enabled: boolean }>>;
  version: number;
  timestamp: number;
}
