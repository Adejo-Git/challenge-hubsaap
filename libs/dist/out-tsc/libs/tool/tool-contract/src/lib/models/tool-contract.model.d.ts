...
export interface ToolLifecycleHooks {
     ...
     */
    onContextChange?: (oldContext: Record<string, unknown> | null, newContext: Record<string, unknown>) => void | Promise<void>;
    /**
...
//# sourceMappingURL=tool-contract.model.d.ts.map