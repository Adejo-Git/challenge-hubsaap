 ...
 */
import { ErrorCategory, Severity, } from '@hub/error-model';
/**
...
export class UnsupportedRbacStrategyError extends Error {
    strategy;
    code = 'UNSUPPORTED_RBAC_STRATEGY';
...
//# sourceMappingURL=permission-rbac.errors.js.map